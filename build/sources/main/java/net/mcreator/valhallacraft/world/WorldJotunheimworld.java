...
package net.mcreator.valhallacraft.world;
...
import net.mcreator.valhallacraft.item.ItemJotunheimworld;
...
public class WorldJotunheimworld extends ElementsValhallaCraft.ModElement {
	public static int DIMID = 3;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("valhallacraft:jotunheimworld_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;
	public WorldJotunheimworld(ElementsValhallaCraft instance) {
		super(instance, 3);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemJotunheimworld().setUnlocalizedName("jotunheimworld").setRegistryName("jotunheimworld"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension jotunheimworld is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("jotunheimworld", "_jotunheimworld", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemJotunheimworld.block, 0,
				new ModelResourceLocation("valhallacraft:jotunheimworld", "inventory"));
	}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("jotunheimworld_portal");
			setRegistryName("jotunheimworld_portal");
			setLightLevel(0.52F);
		}
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("valhallacraft:jotunheim")),};
